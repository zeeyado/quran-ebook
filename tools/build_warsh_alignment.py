...
def main() -> int:
    ...
    lua_path = PROJECT_ROOT / "tools" / "quran.koplugin" / "warshalign.lua"
    lua_path.write_text(
        "-- Generated by tools/build_warsh_alignment.py -- DO NOT EDIT.\n"
        "-- Warsh ayah number -> first covering Hafs ayah, divergent surahs\n"
        "-- only (surahs absent here map identically). Verification:\n"
        "-- scripts/dev_checks/check_warsh_alignment.py; design:\n"
        "-- docs/warsh_alignment_design.md.\n"
        "return {\n" + "\n".join(lua_rows) + "\n}\n",
        encoding="utf-8")
